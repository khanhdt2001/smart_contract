...
describe("LendingFactory", function () {
   ...
   describe("lenderMakeOffer", () => {
      it("fail", async () => {
         await expect(
            lendingFactory.connect(address2).lenderMakeOffer(1, 12, 1814400, 3)
         ).to.be.revertedWith("Address must be registered");
      });
      it("fail", async () => {
      ...
      it("fail", async () => {
         await setUpLenderMakeOffer();
         await expect(
            lendingFactory.connect(address2).lenderMakeOffer(0, 12, 1814400, 4)
         ).to.be.revertedWith(
      ...
      it("fail", async () => {
         await setUpLenderMakeOffer();
         await expect(
            lendingFactory.connect(address2).lenderMakeOffer(0, 12, 3456000, 1)
         ).to.be.revertedWith(
            "Lending: offer time and payment time are not valid"
         );
      });
   ...
   describe.only("vendorAcceptOffer", () => {
    //   it("fail", async () => {
    //      await expect(
   ...
   describe("vendorPayRountine", () => {
      it("fail", async () => {
         ...
         await lendingFactory.connect(address1).vendorPayRountine(0);
      });
   });
});
